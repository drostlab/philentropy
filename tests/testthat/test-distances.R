...
test_that("distance(method = 'manhattan') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(V, W), method = "manhattan")), as.vector(stats::dist(base::rbind(V,W), method = "manhattan")))
})
...
test_that("distance(method = 'gower') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "gower")), (1/length(1:10)) * sum(abs((P) - (Q))))
...
test_that("distance(method = 'soergel') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "soergel")), sum(abs((P) - (Q))) / sum(apply(rbind(P, Q),2,max)))
...
test_that("distance(method = 'ruzicka') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "ruzicka")), 1 - (sum(abs((P) - (Q))) / sum(apply(rbind(P, Q),2,max))))
...
test_that("distance(method = 'hellinger') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "hellinger")), 2 * sqrt(1 - sum(sqrt(P * Q))))
...
test_that("distance(method = 'divergence') computes the correct distance value.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "divergence")), 2 * sum(((P) - (Q))^2 / ((P) + (Q))^2))
...
test_that("distance(method = 'taneja') computes the correct distance value using unit = log.", {
        ...
        expect_equal(as.vector(philentropy::distance(rbind(P, Q), method = "taneja")), sum(((P + Q) / 2) * log((P+Q) / (2 * sqrt(P*Q)))) )
