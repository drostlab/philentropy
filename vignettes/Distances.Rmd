...
Now let's compare the run times of base R and `philentropy`. For this purpose you need to install the [microbenchmark](http://cran.r-project.org/web/packages/microbenchmark/index.html) package.
...
### Specifying the arguments in `distance()`



## Details: Distance and Similarity Measures
